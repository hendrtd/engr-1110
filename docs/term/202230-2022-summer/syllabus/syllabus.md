...
# ENGR 1110 Introduction to Software Engineering <br> Summer 2022 Course Syllabus
...
------- | --- | ---- | --------
002     | T   | 9:45 AM - 12:45 PM  | Davis 302  

## Lab

Section   | Day | Time | Location
-------   | --- | ---- | --------
002       | R   | 9:45 AM - 11:00 AM | Shelby 2205  
...
A secondary, optional text for the course is *Leading with Cultural
Intelligence* by David Livermore (2015). Developing cultural awareness and
cultural competencies is one aim of the course, and you may find this book
helpful.
...
- **MakerSpace** (5%): Training and certification in the College of Engineering
  MakerSpace will be required.

- **Attendance** (10%): Attendance in lecture and lab is required and will be
...
points earned on the Project, *M* is the percentage of possible points earned on
MakerSpace activities, and *R* is the percentage of possible points earned on
Attendance. Each percentage is calculated as (*points earned* / *points
possible*) * 100.


*Total* = (0.25 * *A*) + (0.25 * *L*) + (0.35 * *P*) + (0.10 * *A*) + (0.05 *
*R*)
...
The course is organized into eight modules scheduled as shown below.

- **Module 0**: Wednesday, May 18 - Sunday, May 22  

- **Module 1**: Monday, May 23 - Wednesday, June 1  

- **Module 2**: Thursday, June 2 - Saturday, June 11  

- **Module 3**: Sunday, June 12 - Tuesday, June 21  

- **Module 4**: Wednesday, June 22 - Friday, July 1  

- **Module 5**: Saturday, July 2 - Monday, July 11  

- **Module 6**: Tuesday, July 12 - Thursday, July 21  

- **Module 7**: Friday, July 22 - Sunday, July 31  
...
Module 0 begins on the first day of class and ends on the first Sunday of the
term. Modules 1-7 are each 10 days in duration.
